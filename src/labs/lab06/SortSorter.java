...
public class SortSorter {
     ...
     * the strings for sorting. Then count the number of stings in the queue and
     * create a string array. Next dequeue the strings into the array and sort
     * the stings. Lastly print out the sorted strings and prompt the user if
    ...
    /**
     * Method to recursively quick sort each upper and lower partition of a
     * string by number of "sort".
     */
    ...
    /**
     * Sort strings by using quick sort which has an average time complexity of
     * O(n log n). First select the last string as the initial pivot and get the
     * number of "sort" for all the other strings to compare against. Then sort
     * the strings normally using quick sort and return the new index of the
     * pivot to call quick sort again.
     */
    ...
    /**
     * Count the number of instance of "sort" in a string by getting the index
     * of the first character of "sort" in the string using String.indexOf. If
     * String.indexOf returns -1, meaning there is no "sort" in the string,
     * return 0 for there are no "sort" in the string. Else recursively call
     * itself with the front of the string including "sort" removed to count
     * additional "sort" and return the result of the recursive call plus one.
     */

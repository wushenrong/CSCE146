...
public class OrderScheduler {
  ...
  /**
   * Advance time by incrementing the current time by one minute and cook the the current order by
   * one minute. If the current order is done cooking, calculate how long to prepare the order and

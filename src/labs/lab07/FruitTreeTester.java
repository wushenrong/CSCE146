...
public class FruitTreeTester {
    ...
    /**
     * Main function to test four subfunctions of the tree, adding, printing in
     * order, pre order, and post order, and removing a fruit.
     */
    ...
    /**
     * Creating a fruit tree by asking the user for a fruit file. Then read each
     * line of the file and splitting the line by the delimiter. If the number
     * of the fields is not 2, skip the line. Else add the fruit by its type and
     * weight.
     */
    ...
    /**
     * Test if the remove function of the tree is working by removing an
     * existing fruit and print the tree in order to see if the has been
     * removed.
     */
    public static void deleteFruit() {
        System.out.println("Deleting: " + FRUIT_TYPE_TO_DELETE + Fruit.DELIMITER + FRUIT_WEIGHT_TO_DELETE);

...
public class SheepScheduler {
   ...
   * time of arrival and shearing them. If the sheep is done shearing, add the sheep to the
   * schedule.
   */
  ...
  /**
   * Prompt the user if they want to create another schedule. If yes, return false for not quitting
   * the scheduler. If no, return true to quit. Else prompt for a valid input.
   */
  ...
  /**
   * Get sheep from a sheep list by creating a new GenericLinkedQueue to store the sheep for
   * sorting. Then read each line of the file for the sheep. Next split the line to get the name,
   * shearing time, and arrival time of the sheep. If there are 3 fields in the line, create a new
   * sheep. Else process the next line.
   */
